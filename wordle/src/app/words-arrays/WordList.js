...
// }
// let arr = []
// for (let i = 0; i < WORDSCheckList.length; i++) {
//   let check = 0
//   for (var d = 0; d < WORDSCheckList[i].length; d++) {
//     for (var c = 0; c < WORDSCheckList[i].length; c++) {
//       if (WORDSCheckList[i][d] === WORDSCheckList[i][c]) {
//         check++
//       }
//     } 
//   }
//   if (check === 5) {
//     arr.push(WORDSCheckList[i])
//   }
// }
// let cigarLetters = ['c', 'i', 'g', 'a', 'r']
// let cigar = []
// for (let i = 0; i < arr.length; i++) {
//   let check = 0
//   for (var d = 0; d < arr[i].length; d++) {
//     if (arr[i][d].match(".*[c, i, g, a, r].*")) {
//       check++
//     }
//   }
//   if (check === 0) {
