...
export const initState = {
		...
		help: {
			...
			grayExample4: 'U',
			grayExample5: 'E',
			grayExplanationA: 'The letter ',
			grayExplanationStrong: 'V',
			grayExplanationB: ' is not in the word in any spot.',
			yellowExample1: 'P',
			yellowExample2: 'I',
			yellowExample3: 'L',
			yellowExample4: 'L',
			yellowExample5: 'S',
			yellowExplanationA: 'The letter ',
			yellowExplanationStrong: 'I',
			yellowExplanationB: ' is in the word but in the wrong spot.',
			greenExample1: 'W',
			greenExample2: 'E',
			greenExample3: 'A',
			greenExample4: 'R',
			greenExample5: 'Y',
			greenExplanationA: 'The letter ',
			greenExplanationStrong: 'A',
			greenExplanationB: ' is in the word and in the correct spot.',
		...
		case 'עב':
		  ...
		  return {...state,
					...
					help: {
						...
						grayExample4: 'ס',
						grayExample5: 'נ',
						grayExplanationA: '.האות  ',
						grayExplanationStrong: 'נ',
						grayExplanationB: ' לא במילה  בשום מקום',
						yellowExample1: 'ן',
						yellowExample2: 'ו',
						yellowExample3: 'ק',
						yellowExample4: 'י',
						yellowExample5: 'ת',
						yellowExplanationA: '.האות ',
						yellowExplanationStrong: 'י',
						yellowExplanationB: ' במילה  אבל לא במקום הנכון',
						greenExample1: 'ה',
						greenExample2: 'ב',
						greenExample3: 'ו',
						greenExample4: 'ש',
						greenExample5: 'ת',
						greenExplanationA: '. האות ',
						greenExplanationStrong: 'ו',
						greenExplanationB: ' במילה ובמקום הנכון',
