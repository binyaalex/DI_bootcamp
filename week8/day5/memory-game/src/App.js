  ...
  constructor() {
    ...
    this.state = {
     ...
     choose = (id) => {
        ...
        if (!superheroes[id-1].clicked) {
          superheroes[id-1].clicked = true
          this.state.score++
          if (this.state.score == 12) {
            document.querySelector('h1').textContent = 'You Win The Game!!!!!!!!!!!'
          }
        } else {
        ...
        this.setState([...this.state.randomArr])
      }
